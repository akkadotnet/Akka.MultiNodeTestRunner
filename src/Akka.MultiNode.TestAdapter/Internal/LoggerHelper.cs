...
namespace Akka.MultiNode.TestAdapter.Internal
{
    ...
    {
        public LoggerHelper(IMessageLogger innerLogger, Stopwatch stopwatch)
        {
        ...
        private void SendMessage(TestMessageLevel level, string assemblyName, string message)
        {
            ...
            InnerLogger.SendMessage(level, $"[MultiNode {Stopwatch.Elapsed:hh\\:mm\\:ss\\.ff}] {assemblyText}{message}");
        }
    }
}